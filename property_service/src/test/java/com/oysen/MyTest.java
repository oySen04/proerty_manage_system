...
public class MyTest {
    ...
    public void testGenerator() {
        ...
        globalConfig.setAuthor("yang")
                .setOutputDir("E:\\WebProjects\\proerty_manage_system\\property_service\\src\\main\\java")//设置输出路径
        ...
        dataSourceConfig.setDriverName("com.mysql.cj.jdbc.Driver").setUrl("jdbc:mysql://localhost:3306/property_service?serverTimezone=UTC")
                .setUsername("root").setPassword("52yt1314");
        ...
        packageConfig.setParent("com.oysen").setMapper("mapper")
